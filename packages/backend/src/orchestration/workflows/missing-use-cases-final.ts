...
export const workflows: WorkflowDefinition[] = [
  // Energy - Missing Use Cases (exact IDs from MissionControlV2)
  {
  ...
  // Financial Services - Missing Use Cases
  {
    ...
    workflow: {
      ...
      metadata: {
        ...
        requiredAgents: ['Data Collection Vanguard', 'Credit Scoring Vanguard', 'Fairness Validation Vanguard'],
        estimatedDuration: 30000,
        criticality: 'high',
        compliance: ['FCRA', 'ECOA'],
        tags: ['credit', 'fairness', 'explainable-ai']
      },
      createdAt: new Date(),
      updatedAt: new Date()
    }
  },
  {
    ...
    workflow: {
      ...
      description: 'Advanced anti-money laundering monitoring',
      industry: 'finance',
      version: '1.0.0',
      steps: [
        {
          ...
          type: 'detect',
          agent: 'Transaction Monitor Vanguard',
        ...
        {
          id: 'analyze-patterns',
          name: 'Analyze Suspicious Patterns',
          type: 'analyze',
          ...
          conditions: [
            {
              field: 'monitor-transactions.alerts',
              operator: 'exists',
              value: true
            }
          ],
          outputs: ['suspiciousActivity'],
          errorHandling: {
            retry: { attempts: 2, delay: 3000 }
          }
        },
        {
          id: 'investigate-alerts',
          name: 'Investigate Alerts',
          type: 'decide',
          agent: 'Alert Investigation Vanguard',
          service: 'aml-monitoring',
          action: 'investigateAlerts',
          parameters: {
            enhancedDueDiligence: true
          },
          outputs: ['investigationResults'],
          humanApprovalRequired: true,
          errorHandling: {
            escalate: true
          }
        },
        {
          ...
          conditions: [
            {
              field: 'investigate-alerts.investigationResults.reportRequired',
              operator: '=',
              value: true
            }
          ],
          outputs: ['filedReports'],
          errorHandling: {
            retry: { attempts: 3, delay: 10000 }
          }
        }
      ...
      triggers: [
        {
          type: 'event',
          event: 'transaction.suspicious.detected'
        }
      ],
      metadata: {
        requiredServices: ['aml-monitoring'],
        requiredAgents: ['Transaction Monitor Vanguard', 'Pattern Analysis Vanguard', 'Alert Investigation Vanguard', 'Regulatory Filing Vanguard'],
        estimatedDuration: 90000,
        criticality: 'critical',
        compliance: ['BSA', 'FATF'],
        tags: ['aml', 'compliance', 'monitoring']
      },
      createdAt: new Date(),
      updatedAt: new Date()
    }
  },
  {
    ...
    workflow: {
      ...
      steps: [
        {
          ...
          type: 'detect',
          agent: 'Application Collection Vanguard',
          service: 'insurance-risk',
          action: 'collectApplication',
          parameters: {
            dataValidation: true
          },
          outputs: ['applicationData'],
          errorHandling: {
            retry: { attempts: 3, delay: 5000 }
          }
        },
        ...
        },
        {
          ...
          type: 'decide',
          agent: 'Premium Calculation Vanguard',
          service: 'insurance-risk',
          action: 'calculatePremium',
          parameters: {
            competitiveAnalysis: true
          },
          outputs: ['pricingDecision'],
          humanApprovalRequired: true,
          errorHandling: {
            escalate: true
          }
      ...
      metadata: {
        requiredServices: ['insurance-risk'],
        requiredAgents: ['Application Collection Vanguard', 'Risk Assessment Vanguard', 'Premium Calculation Vanguard'],
        estimatedDuration: 120000,
        criticality: 'high',

...
import oilfieldReportsRoutes from './routes/oilfield-reports.routes';
import vanguardActionsRoutes from './routes/vanguard-actions.routes';
import unifiedReportsRoutes from './routes/unified-reports.routes';
...
// Serve static files from public/reports directory
...
app.use('/api/oilfield-reports', oilfieldReportsRoutes);
app.use('/api/vanguard-actions', vanguardActionsRoutes);
app.use('/api/unified-reports', unifiedReportsRoutes);

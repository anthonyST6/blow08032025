/**
 * Simple Node.js script to test Mission Control persistence functionality
 * Run with: node test-persistence-simple.cjs
 */
...
function runAllTests() {
  ...
  if (passed === total) {
    ...
    console.log(`\n${colors.cyan}The PersistedStateIndicator component will show when:`);
    console.log(`  1. A use case is selected in Mission Control`);
    console.log(`  2. The user navigates to another page`);
    console.log(`  3. The user returns to Mission Control${colors.reset}`);
  } else {
